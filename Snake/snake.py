...
def create_block():
    """ Створюємо блок в випадковій позиції на карті """
    global BLOCK
...
def main():
    ...
    if IN_GAME:
        ...
        root.after(75, main) # Тут змінюємо швидкість
    else:
...
root = Tk() 
root.title("Snake") 
c = Canvas(root, width = WIDTH, height = HEIGHT, bg = "lime")
c.grid() 
...
restart_text = c.create_text(WIDTH/2, HEIGHT-HEIGHT/3, 
    font = 'Arial 30',      
    fill = 'red',       
    text = "Нажми на мене, щоб ще раз зіграти.",    
    state = 'hidden')   
